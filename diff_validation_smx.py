...
if local:
    csv_file_spot = "validation/diff_validation_smx_spot.csv"
    csv_file_forw = "validation/diff_validation_smx_forw.csv"
    log = "model_metrics.log"
    max_workers = 2
else:
    csv_file_spot = "/storage/users/mariumbo/validation/diff_validation_smx_spot.csv"
    csv_file_forw = "/storage/users/mariumbo/validation/diff_validation_smx_forw.csv"
