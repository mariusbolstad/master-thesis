...
if local:
    csv_file_spot = "validation/level_vs_diff_spot.csv"
    csv_file_forw = "validation/level_vs_diff_forw.csv"
    log = "model_metrics.log"
    max_workers = 2
else:
    csv_file_spot = "/storage/users/mariumbo/validation/level_vs_diff_spot.csv"
    csv_file_forw = "/storage/users/mariumbo/validation/level_vs_diff_forw.csv"
