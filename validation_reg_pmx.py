...
if local:
    csv_file_spot = "validation/validation_reg_diff_pmx_spot.csv"
    csv_file_forw = "validation/validation_reg_diff_pmx_forw.csv"
    log = "model_metrics.log"
    max_workers = 2
else:
    csv_file_spot = "/storage/users/mariumbo/validation/validation_reg_diff_pmx_spot.csv"
    csv_file_forw = "/storage/users/mariumbo/validation/validation_reg_diff_pmx_forw.csv"
