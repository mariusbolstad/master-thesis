...
if local:
    csv_file_spot = "validation/reg_pmx_spot.csv"
    csv_file_forw = "validation/reg_pmx_spot.csv"
    log = "model_metrics.log"
    max_workers = 2
else:
    csv_file_spot = "/storage/users/mariumbo/validation/reg_pmx_spot.csv"
    csv_file_forw = "/storage/users/mariumbo/validation/reg_pmx_spot.csv"
